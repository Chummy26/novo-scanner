...
`CLAUDE.md` e `AGENTS.md` são cópias normativas idênticas deste mesmo documento; qualquer alteração em um deve ser aplicada ao outro no mesmo commit para evitar divergência entre agentes.
