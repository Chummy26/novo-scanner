        ...
        DatasetKind::LabeledTrades => Schema::new(vec![
            ...
            struct_field(
                ...
                vec![
                    ...
                    f32_field("gross_if_closed_now_pct"),
                    bool_field("t0_round_trip_near_zero"),
            ...
            bool_field("audit_first_hit_exit_near_zero"),
            utf8_field("audit_spread_artifact_kind"),
            utf8_field("outcome"),
    ...
    fn compacts_labeled_jsonl_to_parquet() {
        ...
        write_lines(
            ...
            &[concat!(
                ...
                r#""schema_version":12,"scanner_version":"0.1.0","#,
                ...
                r#""gross_if_closed_now_pct":1.0,"t0_round_trip_near_zero":false,"#,
                ...
                r#""audit_first_hit_exit_near_zero":false,"audit_spread_artifact_kind":"none","#,
